...
5. 双人一致性、裁决和事件级误触发/检出延迟的 E1 工具口径已由 [G4 事件评估就绪门](v1-g4-event-evaluation-readiness.md)关闭；首版候选规则已由 [REV-017 候选 episode 设计](v1-g4-fall-event-candidates.md)在 held-out 前冻结。真实标注内容抽查、冻结策略的 C6c 候选/事件指标和多人策略仍 Open。
