...
| V1-M2c 采集包就绪门 E1 工具 | `8838168` / `6928ac8` / `542bddf` / `6f1c02a` | 待推送 | 2026-07-22 本地已验证 | manifest 1.1、场景/标注、文件/媒体、双同步事件、三模型 held-out 摘要、两级 readiness 与 REV-014；不代表取得真机样本 |
