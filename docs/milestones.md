...
| V1-M1 Stream Session wall/media 双时长门加固 | `ab1f366` / `508c667` | `origin/main` | 待本次推送验证 | 父级 ready media 重算、wall/media 独立 gate、30 分钟双声明/双观测契约正反例、两条 clean E1 与 REV-029；不代表实际运行 30 分钟、C6c 或 RTSP 长稳 |
