...
| V1-M2b 真实样本与对齐 | 07-29～08-01 | Planned | C6c 音视频样本、时间基、睡眠样例与统一产物 | 目标设备视频、音频、睡眠样例可追溯且时间语义明确 |
...
| V1-M2a 多模态链路 | `fb39903` | `origin/main` | 待本次推送验证 | 视频/语言回放、模型绑定、融合窗口、Slurm 脚本与测试；不代表真实设备或 V2 模型验收 |
...
证据见 [V1-M2a 多模态 Pipeline 初测报告](reports/v1-m2a-multimodal-smoke.md)。下一门是 V1-M2b 真实 C6c 音视频时间基和受控居家样本，不允许用公开 bus/WAV 样本代替。
